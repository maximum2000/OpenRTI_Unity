...
extern "C"
{
    ...
    __declspec(dllexport) void RegisterСonnectionLostCallback(сonnectionLostCallback callback);
}
...
void RegisterСonnectionLostCallback(сonnectionLostCallback callback)
{
